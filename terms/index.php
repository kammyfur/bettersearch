...
<body about>
    ...
    if ($langc == "fr") {
        echo(file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/terms/index-fr.html"));
    } else {
        echo(file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/terms/index-en.html"));
    }
    
    ?>
    <p><center><small>
    Copyright © <?= date('Y') ?> Minteck Projects, <?= $lang->rights ?><br>
    <?= $lang->trademark ?>
    </small></center></p>
</body>
</html>